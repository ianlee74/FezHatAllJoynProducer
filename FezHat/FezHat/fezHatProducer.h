...
extern PCSTR c_fezHatIntrospectionXml;

ref class fezHatProducer;

public interface class IfezHatProducer
{
    event Windows::Foundation::TypedEventHandler<fezHatProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<fezHatProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<fezHatProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<fezHatProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class fezHatProducer sealed : [Windows::Foundation::Metadata::Default] IfezHatProducer
{
public:
    fezHatProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~fezHatProducer();

    // The implementation of IfezHatService that will handle method calls and property requests.
    property IfezHatService^ Service
    {
        IfezHatService^ get() { return m_serviceInterface; }
        void set(IfezHatService^ value) { m_serviceInterface = value; }
    }
    ...
    virtual event Windows::Foundation::TypedEventHandler<fezHatProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<fezHatProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<fezHatProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<fezHatProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    static void CallSwitchD2Handler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSwitchD3Handler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    ...
    IfezHatService^ m_serviceInterface;
