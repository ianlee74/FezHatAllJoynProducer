...
public interface class IfezhatnodeConsumer
{
    event Windows::Foundation::TypedEventHandler<fezhatnodeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<fezhatnodeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<fezhatnodeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class fezhatnodeConsumer sealed  : [Windows::Foundation::Metadata::Default] IfezhatnodeConsumer
{
public:
    fezhatnodeConsumer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~fezhatnodeConsumer();
    ...
    static Windows::Foundation::IAsyncOperation<fezhatnodeJoinSessionResult^>^ JoinSessionAsync(_In_ Windows::Devices::AllJoyn::AllJoynServiceInfo^ serviceInfo, _Inout_ fezhatnodeWatcher^ watcher);

    // Call the SetRedLedState method
    Windows::Foundation::IAsyncOperation<fezhatnodeSetRedLedStateResult^>^ SetRedLedStateAsync(_In_ bool interfaceMemberOn);
    // Call the GetRedLedState method
    Windows::Foundation::IAsyncOperation<fezhatnodeGetRedLedStateResult^>^ GetRedLedStateAsync();
    // Call the SetRgbLedD2Color method
    Windows::Foundation::IAsyncOperation<fezhatnodeSetRgbLedD2ColorResult^>^ SetRgbLedD2ColorAsync(_In_ bool interfaceMemberOn, _In_ byte interfaceMemberRed, _In_ byte interfaceMemberGreen, _In_ byte interfaceMemberBlue);
    // Call the SetRgbLedD3Color method
    Windows::Foundation::IAsyncOperation<fezhatnodeSetRgbLedD3ColorResult^>^ SetRgbLedD3ColorAsync(_In_ bool interfaceMemberOn, _In_ byte interfaceMemberRed, _In_ byte interfaceMemberGreen, _In_ byte interfaceMemberBlue);
    // Call the GetLightSensorValue method
    Windows::Foundation::IAsyncOperation<fezhatnodeGetLightSensorValueResult^>^ GetLightSensorValueAsync();
    // Call the GetTemperatureSensorValue method
    Windows::Foundation::IAsyncOperation<fezhatnodeGetTemperatureSensorValueResult^>^ GetTemperatureSensorValueAsync();
    ...
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;

    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeConsumer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
