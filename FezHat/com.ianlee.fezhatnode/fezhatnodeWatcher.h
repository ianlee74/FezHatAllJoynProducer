...
ref class fezhatnodeWatcher;

public interface class IfezhatnodeWatcher
{
    event Windows::Foundation::TypedEventHandler<fezhatnodeWatcher^, Windows::Devices::AllJoyn::AllJoynServiceInfo^>^ Added;
    event Windows::Foundation::TypedEventHandler<fezhatnodeWatcher^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
};

public ref class fezhatnodeWatcher sealed : [Windows::Foundation::Metadata::Default] IfezhatnodeWatcher
{
public:
    fezhatnodeWatcher(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~fezhatnodeWatcher();

    // This event will fire whenever a producer for this service is found.
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeWatcher^, Windows::Devices::AllJoyn::AllJoynServiceInfo^>^ Added;

    // This event will fire whenever the watcher is stopped.
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeWatcher^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
