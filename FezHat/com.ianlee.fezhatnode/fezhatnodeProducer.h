...
extern PCSTR c_fezhatnodeIntrospectionXml;

ref class fezhatnodeProducer;

public interface class IfezhatnodeProducer
{
    event Windows::Foundation::TypedEventHandler<fezhatnodeProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    event Windows::Foundation::TypedEventHandler<fezhatnodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    event Windows::Foundation::TypedEventHandler<fezhatnodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;
    event Windows::Foundation::TypedEventHandler<fezhatnodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
};

public ref class fezhatnodeProducer sealed : [Windows::Foundation::Metadata::Default] IfezhatnodeProducer
{
public:
    fezhatnodeProducer(Windows::Devices::AllJoyn::AllJoynBusAttachment^ busAttachment);
    virtual ~fezhatnodeProducer();

    // The implementation of IfezhatnodeService that will handle method calls and property requests.
    property IfezhatnodeService^ Service
    {
        IfezhatnodeService^ get() { return m_serviceInterface; }
        void set(IfezhatnodeService^ value) { m_serviceInterface = value; }
    }

    // Used to send signals or register functions to handle received signals.
    property fezhatnodeSignals^ Signals
    {
        fezhatnodeSignals^ get() { return m_signals; }
    }
    
    // This event will fire whenever this producer is stopped.
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeProducer^, Windows::Devices::AllJoyn::AllJoynProducerStoppedEventArgs^>^ Stopped;
    
    // This event will fire whenever the producer loses the session that it created.
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionLostEventArgs^>^ SessionLost;
    
    // This event will fire whenever a member joins the session.
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberAddedEventArgs^>^ SessionMemberAdded;

    // This event will fire whenever a member leaves the session.
    virtual event Windows::Foundation::TypedEventHandler<fezhatnodeProducer^, Windows::Devices::AllJoyn::AllJoynSessionMemberRemovedEventArgs^>^ SessionMemberRemoved;
...
private:
    static void CallSetRedLedStateHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallGetRedLedStateHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetRgbLedD2ColorHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallSetRgbLedD3ColorHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallGetLightSensorValueHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallGetTemperatureSensorValueHandler(_Inout_ alljoyn_busobject busObject, _In_ alljoyn_message message);
    static void CallButtonDio18PressedSignalHandler(_In_ const alljoyn_interfacedescription_member* member, _In_ alljoyn_message message);
    static void CallButtonDio22PressedSignalHandler(_In_ const alljoyn_interfacedescription_member* member, _In_ alljoyn_message message);
    ...
    fezhatnodeSignals^ m_signals;
    IfezhatnodeService^ m_serviceInterface;
